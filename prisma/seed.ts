...
async function main() {
  ...
  const sampleProducts = [
    ...
    },
    {
      ...
      description: 'A warm, sweet amber and cedarwood fragrance that makes your car cabin feel cozy, calm, and welcoming. Blends smooth amber with soft cedarwood and a pinch of warm spices. Perfect for daily driving and evening rides. Comes in a 10ml glass bottle with a handcrafted beechwood diffuser cap.',
    ...
    },
    {
      ...
      description: 'A bold, masculine fragrance inspired by luxury car leather upholstery and fine wood. Combines rich leather aroma with earthy oakmoss and a touch of black pepper for a powerful executive vibe. Comes in a 10ml glass bottle with a handcrafted beechwood diffuser cap.',
    ...
    },
    {
      ...
      description: 'A crisp, fresh citrus fragrance that instantly lifts your driving mood. Made with zesty Italian bergamot, fresh orange notes, and clean musk to keep your car smelling naturally clean and fresh, even in hot Indian summers. Comes in a 10ml glass bottle with a handcrafted beechwood diffuser cap.',
